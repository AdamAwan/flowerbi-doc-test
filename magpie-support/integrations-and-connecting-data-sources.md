...
|------|---------------|---------|
| `local` | A local filesystem path | `{"id":"docs","kind":"local","path":"knowledge-bases/product"}` |
...
For local development, a source path inside the repository or an absolute path can be used. No bundled knowledge base is included; create your own folder or point to an existing one.
...
*Based on source material from: `README.md`, `docs/ingestion.md`, `docs/chat-providers.md`, `docs/architecture.md`, `docs/ai-jobs.md`, `docs/mcp.md`.*
